...
def forwards_func(apps, schema_editor):
    ...
    MFileSuffix = apps.get_model("metab", "MFileSuffix")
    MsLevel = apps.get_model("metab", "MsLevel")
    Polarity = apps.get_model("metab", "Polarity")
...
def reverse_func(apps, schema_editor):
    ...
    MFileSuffix = apps.get_model("metab", "MFileSuffix")
    MassType = apps.get_model("metab", "MassType")
    MsLevel = apps.get_model("metab", "MsLevel")
    PolaritySearch = apps.get_model("metab", "PolaritySearch")
