...
urlpatterns = [
    ...
    url('^general_summary/$', views.GeneralSummaryView.as_view(), name='general_summary'),
    ...
    url('^f6rag4feature/(?P<cgid>\d+)$', views.Frag4FeatureListView.as_view(), name='frag4feature'),
    url('^canns/(?P<cgid>\d+)$', views.CAnnotationsListView.as_view(), name='canns'),
    url('^canns_all/$', views.CAnnotationsListAllView.as_view(), name='canns_all'),
