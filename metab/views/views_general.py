...
from metab.models import MFile, Run, MFileSuffix
from metab.forms import UploadMFilesBatchForm, MFileForm, UploadAdductsForm
from metab.tables import MFileTable
from metab.filter import MFileFilter
from metab.tasks import upload_files_from_dir_task
from metab.utils.mfile_upload import upload_files_from_zip
from metab.utils.upload_adduct_rules import upload_adduct_rules
...
class MFileCreateView(GFileCreateView):
    ...
    template_name = 'metab/mfile_form.html'
...
class UploadMFilesBatch(LoginRequiredMixin, View):
    ...
    # initial = {'key': 'value'}
    template_name = 'metab/upload_mfiles_batch.html'
...
class MFileListView(GFileListView):
    ...
    template_name = 'metab/mfile_summary.html'
...
class UploadAdductRules(LoginRequiredMixin, View):
    ...
    success_url = '/dma/success'
    # initial = {'key': 'value'}
    template_name = 'metab/upload_adduct_rules.html'
...
class GeneralSummaryView(LoginRequiredMixin, View):
    # initial = {'key': 'value'}
    template_name = 'metab/general_summary.html'
