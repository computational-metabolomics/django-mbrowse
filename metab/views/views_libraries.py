...
from metab.models import LibrarySpectraSource
from metab.forms import LibrarySpectraSourceForm

from metab.tasks import upload_library

from metab.models import SpectralMatching, SPeak, LibrarySpectra, LibrarySpectraMeta, CPeakGroupMeta, CPeakGroup
from metab.tables import SpectralMatchingTable, SPeakTable
...
class CPeakGroupSpectralMatchingListView(LoginRequiredMixin, SingleTableMixin, ListView):
    ...
    template_name = 'metab/cpeakgroup_spectral_matching_summary.html'
...
class SMatchView(LoginRequiredMixin, SingleTableMixin, ListView):
    ...
    model = SPeak
    template_name = 'metab/spectral_matching.html'
